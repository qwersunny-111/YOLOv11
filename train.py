...
if __name__ =='__main__':
	# 模型大小从小到大有n, s, m, l, x，需要哪一个就改11后面的字母
    model = YOLO('ultralytics/cfg/models/11/yolo11s.yaml')
    # model.load('/home/sunleyao/sly/ultralytics/runs/detect/train8/weights/last.pt')
  
    # 定义训练参数，添加默认值、范围和中文注释
    train_params = {
        'data': "ultralytics/cfg/datasets/weed_data_2.yaml",   # 数据集配置文件路径，需要自定义修改
        'epochs': 100,              # 总训练轮次，默认值 100，范围 >= 1
        'imgsz': 568,       # 输入图像大小，默认值 640，范围 >= 32
        'batch': 32, 
        'iou': 0.7,
        ...
        'device': 6,            # 训练设备，默认值 None，支持 "cpu", "gpu"(device=0,1), "mps"
        ...
        # 'weights': '/home/sunleyao/sly/ultralytics/runs/detect/train8/weights/last.pt',  # 指定保存的检查点路径
